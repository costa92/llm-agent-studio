...
// api hooks：shots / assets 用 vi.hoisted 可控 mock。
const { useShotsMock, useProjectAssetsMock } = vi.hoisted(() => ({
...
describe("RunPreview music mode", () => {
  it("渲染歌词行 + 禁用 transport", () => {
    ...
    expect(play.getAttribute("title")).toContain("即将支持")
  })
})
