...
export function PromptListPage({ org }: PromptListPageProps) {
  ...
  return (
    ...
    <CrudResourcePage
      ...
      isEmpty={(prompts.data?.length ?? 0) === 0}
    ...
    >
      <DataView<Prompt>
        ...
        renderCard={(p) => {
          ...
          return (
            <div className="flex flex-col justify-between rounded-xl border border-line bg-bg-surface p-4 text-[12.5px] transition-all hover:border-text-3">
